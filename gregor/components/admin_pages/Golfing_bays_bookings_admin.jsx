...
const Golfing_bays_bookings_admin = () => {
  ...
  const events = [
    {
      title: 'Event 1',
      start: '2023-09-19T12:00:00', // Start date and time
      end: '2023-09-19T13:00:00',   // End date and time
      resourceId: 'player-2',
    ...
    {
      title: 'Event 1',
      start: '2023-09-20T01:00:00', // Start date and time
      end: '2023-09-20T05:00:00',   // End date and time
      resourceId: 'player-3',
      classNames: ["bg-red-500 text-[17px] border-none px-2 py-1 font-sans hover:opacity-75 cursor-default transition-all"]
    },
  ...
  return (
    <div className={`h-[calc(100vh-60px)] overflow-y-scroll px-[30px] relative pt-[30px] pb-[120px] ${styles.scrollBar}`} >
        ...
        <div className='flex items-end gap-14' >
          <div className='flex gap-5' >
            <button
              ...
              className='text-[14px] font-semibold text-slate-600 font-sans border-b border-transparent hover:border-slate-300 leading-loose flex items-center justify-center gap-1 transition-all'
            >
            ...
            <button
              ...
              className='text-[14px] font-semibold text-slate-600 font-sans border-b border-transparent hover:border-slate-300 leading-loose flex items-center justify-center transition-all'
            >
      ...
      {/* <div className='fixed bottom-[30px] z-[10]  left-0 right-0 flex justify-center'>
        <button
          onClick={() => openModal("select_players_modal")}
          className='w-[400px] py-[8px] bg-blue-500 text-white rounded-md text-[17px] font-semibold shadow-2xl shadow-black hover:bg-blue-400 active:bg-blue-300 transition-all'
        >
          Book slot
        </button>
      </div> */}
